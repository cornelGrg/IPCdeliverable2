...
g++-11 -c matTransMPI.cpp -O3 -o ../build/matTransMPI.o
g++-11 -c matTransOMP.cpp -fopenmp -o ../build/matTransOMP.o
g++-11 ../build/support.o ../build/main.o ../build/matTransSEQ.o ../build/matTransMPI.o ../build/matTransOMP.o -fopenmp -o matTrans
